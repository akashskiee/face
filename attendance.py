...
lbl = tk.Label(window, text="Enter Your College ID",width=28  ,height=2  ,fg="black"  ,bg="light blue" ,font=('times', 15, ' bold ') ) 
...
viewatt = tk.Button(window, text="View Attendance", command=run  ,fg="black"  ,bg="blue"  ,width=15  ,height=2, activebackground = "Red" ,font=('times', 10, ' bold '))
viewatt.place(x=1400, y=740)
window.mainloop()